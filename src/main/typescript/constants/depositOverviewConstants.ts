...
export enum DepositOverviewConstants {
    ...
    DELETE_DEPOSIT_CONFIRMATION = "DELETE_DEPOSIT_CONFIRMATION",
    DELETE_DEPOSIT_CANCELLED = "DELETE_DEPOSIT_CANCELLED",
    ...
    CREATE_NEW_DEPOSIT_PENDING = "CREATE_NEW_DEPOSIT_PENDING",
    CREATE_NEW_DEPOSIT_FULFILLED = "CREATE_NEW_DEPOSIT_FULFILLED",
    CREATE_NEW_DEPOSIT_REJECTED = "CREATE_NEW_DEPOSIT_REJECTED",
    CREATE_NEW_DEPOSIT_SUCCESS = "CREATE_NEW_DEPOSIT_SUCCESS",
}
